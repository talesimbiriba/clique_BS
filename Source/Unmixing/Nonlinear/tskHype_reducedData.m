function [ a_est, d, r_est ] = tskHype_reducedData(r,M, kernelType, C, kbw, ousePureNLKernel, M_full, selectedBandsIDX)
...
KM_full = computeKernelMatrix(M_full,kbw);
...
for n = 1 : N
 %   if mod(n,10)==0, n, end
  ...
  %   h = d(1)*(M'*beta+gam);
     ...
     r_est(:,n) = M_full*ht + d(2)*KM_full(:,selectedBandsIDX)*z;
end
%toc
